...
function Cart() {
    ...
    const owner_index = localStorage.getItem("loggedInUserIndex");


    const userCartItems = objectsData.filter(item => item.onwer_index === owner_index);
        ...
        <div className="cart__page">
            <div className="cart__elements">
                ...
                {userCartItems.length > 0 ? (
                    userCartItems.map((object) => (
                    <div className="cart__object" key={object.objectData.id}> {/**/}
                        <img className='cart__img' src={imagePath} height={85} width={85} alt="item"/>
